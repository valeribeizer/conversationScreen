...
class BottomViewController: UIViewController {
  ...
  let currentLabelText = "Missed Call"
  ...
  private func setUpConstraints() {
    NSLayoutConstraint.activate([
      ...
      callLabel.leadingAnchor.constraint(equalTo: self.currentLabel.leadingAnchor),
      callLabel.topAnchor.constraint(equalTo: self.currentLabel.bottomAnchor, constant: 20),
